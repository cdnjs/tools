...
func Invoke(ctx context.Context, e GCSEvent) error {
	...
	var pairs cloudflare.WorkersKVBulkWriteRequest
	...
	res, err := cfapi.WriteWorkersKVBulk(ctx, KV_NAMESPACE, pairs)
	if err != nil {
...
func newMetadata(size int) *FileMetadata {
